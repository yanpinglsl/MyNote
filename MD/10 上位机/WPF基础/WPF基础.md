...
![image-20240117223932929](images/WPF基础/image-20240117223932929.png)
...
![image-20240117230107268](images/WPF基础/image-20240117230107268.png)
...
![image-20240118222409333](images/WPF基础/image-20240118222409333.png)
...
![image-20240123220319896](images/WPF基础/image-20240123220319896.png)
...
![screenshots](images/WPF基础/screenshots-1706621405272-1.gif)
...
![screenshots](images/WPF基础/screenshots-1706622674489-13.gif)
...
![screenshots](images/WPF基础/screenshots-1706622827808-17.gif)
...
![image-20240131113435029](images/WPF基础/image-20240131113435029.png)
...
- 系统资源，一般会在app.xaml中集成:
  ...
  ![image-20240131113543154](images/WPF基础/image-20240131113543154.png)

- 窗体资源，上面例子中的Window.Resources:

  ![image-20240131113554656](images/WPF基础/image-20240131113554656.png)

- 控件资源，上面例子中的Button.Resources:

  ![image-20240131113604927](images/WPF基础/image-20240131113604927.png)
...
![screenshots](images/WPF基础/screenshots-1706679292852-1.gif)
...
![image-20240131133734445](images/WPF基础/image-20240131133734445.png)
...
![image-20240131213654081](images/WPF基础/image-20240131213654081-1706753755870-1.png)
...
![screenshots](images/WPF基础/screenshots-1706710796260-1-1706753755870-3.gif)

XAML中数据绑定模式是双向的，默认情况下，当源对象的值发生变化时，会自动更新目标对象的值，但实际上PasswordBox的Password属性本身不是依赖属性，因此它不支持直接的数据绑定。因此，当你修改第一个TextBox的文本时，会将新的文本值传递给passWD的Password属性，反过来，TextBox的文本是不能响应Password属性的变化的。![image-20240131214055876](images/WPF基础/image-20240131214055876-1706753755870-2.png)
...
一个参数是该依赖属性的名字，第二个参数是依赖属性的类型，第三个参数是该依赖属性的所有者的类型，第五个参数是一个验证值的回调委托，第四个PropertyMetadata是我们上面提到的属性的元数据，上面示例中我们将PropertyMetadata作为依赖属性的初值，事实上它还有很多可以实现强大功能的重载，转到定义可以看到：![image-20240131214921306](images/WPF基础/image-20240131214921306-1706753755870-4.png)
...
![screenshots](images/WPF基础/screenshots-1706710796260-2-1706753755870-5.gif)
...
![image-20240202102050437](images/WPF基础/image-20240202102050437.png)
...
![image-20240202102444473](images/WPF基础/image-20240202102444473.png)
...
![image-20240202134829766](images/WPF基础/image-20240202134829766.png)
...
![screenshots](images/WPF基础/screenshots-1706853884423-1.gif)
...
![image-20240202140942841](images/WPF基础/image-20240202140942841.png)
...
![image-20240205161517693](images/WPF基础/image-20240205161517693.png)
...
![screenshots](images/WPF基础/screenshots-1707121415285-1.gif)
...
![image-20240205162132209](images/WPF基础/image-20240205162132209.png)
...
![screenshots](images/WPF基础/screenshots-1707121510323-5.gif)
...
![screenshots](images/WPF基础/screenshots-1707121836856-7.gif)
...
![screenshots](images/WPF基础/screenshots-1707122603347-9.gif)
...
![screenshots](images/WPF基础/screenshots-1707124120472-11.gif)
...
![screenshots](images/WPF基础/screenshots-1707124657537-13.gif)
...
![screenshots](images/WPF基础/screenshots-1707125243306-15.gif)
...
![screenshots](images/WPF基础/screenshots-1707131043075-17.gif)
